...
@php
$classes = $active
    ? 'flex items-center px-3 py-2 text-sm font-medium rounded-lg text-white transition-colors'
    : 'flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors';
$style = $active ? 'background-color: var(--primary-color);' : '';
...
$icons = [
    ...
    'library' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"/>',
    ...
    'circle' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 12m-9 0a9 9 0 1118 0 9 9 0 01-18 0z"/>',
];
...
<a href="{{ $href }}" class="{{ $classes }}" style="{{ $style }}">
    ...
    <span class="ml-3 truncate" x-show="sidebarOpen" x-transition>{{ $slot }}</span>
</a>
