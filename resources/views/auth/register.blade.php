<x-guest-layout>
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-500">Get started with {{ setting('school_name', 'uSchool') }} today</p>
    </div>
    ...
    <div class="mt-8">
        <div class="relative">
            ...
            <div class="relative flex justify-center text-sm"><span class="bg-white px-4 text-gray-400">Already have an account?</span></div>
        </div>
        <div class="mt-4 text-center">
            <a href="{{ route('login') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-emerald-600 hover:text-emerald-500 transition-colors">
                Sign in instead
